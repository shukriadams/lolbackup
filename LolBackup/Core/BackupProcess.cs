...
namespace LolBackup
{
    ...
    public class BackupProcess
    {
        ...
        readonly WriteMessageDelegate _statusUpdateDelegate;

        readonly WriteMessageDelegate _writeMessageDelegate;

        readonly ProgressBarUpdateDelegate _progressBarUpdateDelegate;
            ...
            )
        {
            try
            {
                ...
                try
                {
                    ...
                    /*
                    // disabled this check, potentially too expensive
                    ...
                    */
                    ...
                    NestedContentFinder finder = new NestedContentFinder(
                        _sourceDirectory, 
                        null, 
                        _blockedFolders.ToArray(), 
                        _statusUpdateDelegate);
                    string[] sourceFiles = finder.Process();

                    int processed = 0;
                    int totalCount = sourceFiles.Length;

                    foreach (string sourceFile in sourceFiles)
                    {
                        processed++;
                        _progressBarUpdateDelegate.Invoke(processed, totalCount);
                    ...
                    if (this.DeleteOrphans)
                    {
                        ...
                        try
                        {
                            ...
                            finder = new NestedContentFinder(
                                _targetDirectory, 
                                null, 
                                null, 
                                _statusUpdateDelegate);

                            targetFiles = finder.Process();
                        }
                        catch (Exception ex)
                        {
